...
export const mockMediaAssetList: MediaAsset[] = [
  ...
  },
  {
    ...
    thumbnailUrl:
      'https://images.pexels.com/photos/1103970/pexels-photo-1103970.jpeg?auto=compress&cs=tinysrgb&w=96&h=96&fit=crop',
  ...
  },
  {
    ...
    thumbnailUrl: 'https://cdn.eso.org/images/thumb300y/eso2008a.jpg',
    status: 'annotated',
    duration: 26,
    annotationCount: 2,
    mediaCreatedBy: 'demo-user',
